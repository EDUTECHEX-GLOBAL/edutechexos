    ...
    <span>
      {parts.map((part, i) =>
        part.toLowerCase() === query.toLowerCase() ? (
          <strong
            key={i}
            className="font-bold text-[#3E4A89] bg-[rgba(62,74,137,0.08)] rounded px-0.5"
          >
            {part}
          </strong>
        ) : (
            ...
            {typeOrder
              ...
              .map((t) => {
                ...
                return (
                  <span
                    key={t}
                    className={`flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-bold ${meta.bg}`}
                    style={{ color: meta.color }}
                  >
                    <meta.icon size={9} />
                    {meta.label}s ({grouped[t].length})
                  </span>
                );
              })}
          </div>
          ...
          <div className="flex flex-col items-center justify-center h-full gap-4 px-8 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-[#7C859E] mt-1 leading-relaxed">
                Messages, wiki pages, and tasks — all in one place.
              </p>
            </div>
              ...
              return (
                <div key={type} className="mb-1">
                  ...
                  {items.map((result) => (
                    ...
                    >
                      <div
                        className={`h-7 w-7 rounded-lg flex items-center justify-center shrink-0 mt-0.5 ${meta.bg}`}
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-0.5">
                          ...
                          <span className="text-[10px] text-[#7C859E] shrink-0">
