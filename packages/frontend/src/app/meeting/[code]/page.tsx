  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#FAFAFA] p-4">
      <div className="w-full max-w-lg rounded-3xl border border-[#E5E5E5] bg-white p-8 shadow-[0_24px_64px_rgba(17,17,17,0.08)]">
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-[#111111]">
        ...
        {info?.channelId && (
          <div className="mt-4 rounded-xl bg-[#FAFAFA] border border-[#E5E5E5] px-4 py-3 text-center">
        ...
        <div className="mt-8 flex flex-col gap-3">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-xl bg-[#111111] px-5 py-3 text-sm font-bold text-white transition-colors hover:bg-[#262626]"
          >
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
