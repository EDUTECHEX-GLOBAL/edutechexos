...
const { createMeetingAccess, checkMeetingAccess, editMeetingAccess, cancelMeetingAccess, grantMeetingAccess, sendMeetingInvite, registerMedia, getMedia, getMeetingRequests, createMeetingRequest, reviewMeetingRequest, lookupMeetingByCode } = require('../controllers/meetingController');
...
router.patch('/meeting-access/:messageId', authMiddleware, requireAuth, editMeetingAccess);
router.delete('/meeting-access/:messageId', authMiddleware, requireAuth, cancelMeetingAccess);
