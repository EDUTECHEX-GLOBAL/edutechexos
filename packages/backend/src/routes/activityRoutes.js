...
const { heartbeat, getLive, getHistory, getStats, awSync, getAw, logMessage, getAttendance, getLoginHistory, getMyAttendance } = require('../controllers/activityController');
