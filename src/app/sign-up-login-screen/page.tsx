  ...
  return (
    ...
    >
      ...
      <main className="relative w-full min-h-screen flex flex-col lg:flex-row overflow-hidden">
        ...
        ══════════════════════════════════════════════════ */}
        <section className="auth-diag relative lg:w-[44%] bg-[#0A1128] z-10 flex flex-col justify-center px-10 md:px-14 lg:px-20 xl:px-24 py-20 lg:py-0 min-h-[380px] lg:min-h-screen">
          {/* Dot grid */}
          <div
          ...
          <div
            ...
            style={{
              ...
              filter: 'blur(60px)',
              animation: 'glow-p 11s ease-in-out infinite 2s',
            }}
          />
          ...
          <div className="relative max-w-md">
            ...
            <div
              ...
              style={{ width: 48, height: 2, background: '#D4AF37', opacity: 0.65 }}
            />
            ...
            <div className="rh d2 flex items-center gap-3 mb-7">
              <div
                style={{ flexShrink: 0, width: 22, height: 1, background: 'rgba(212,175,55,.4)' }}
              />
              <span
                style={{
                  fontSize: 9,
            ...
            <p
              ...
              style={{
                ...
                fontWeight: 400,
                lineHeight: 1.78,
                color: 'rgba(249,248,246,.42)',
                maxWidth: '34ch',
                marginBottom: '2.8rem',
              }}
            >
              Enter the secure gateway of EduTechEx. Continue your journey in developing world-class
              curriculum and academic intelligence.
            </p>
          </div>
        </section>
            ...
            <div style={{ display: 'flex', overflow: 'hidden' }}>
              ...
              >
                {[...Array(2)].map((_, rep) => (
                  <div
                    key={rep}
                    style={{ display: 'flex', alignItems: 'center', gap: 40, paddingRight: 40 }}
                  >
                    {[
                      'Oxford',
                      'Harvard',
