...
const steps = [
  {
    ...
    icon: Users,
    description:
      'Invite team members, assign roles, and set up project channels in under two minutes. Everyone lands in #general automatically.',
    demo: (
      <div className="flex flex-col gap-3">
        <div className="flex -space-x-3 mb-2">
          {[
            ...
            <div
              key={l}
              className="w-12 h-12 rounded-2xl flex items-center justify-center border-2 border-white text-white text-xs font-bold shadow"
          ...
          <div
            className="w-12 h-12 rounded-2xl flex items-center justify-center border-2 border-white text-xs font-bold shadow"
            style={{ background: '#FAF8F5', color: '#4A5578', zIndex: 0 }}
          >
            +3
          </div>
        </div>
        <div className="text-xs font-medium" style={{ color: '#4A5578' }}>
          7 team members · 3 roles · 1 workspace
        </div>
      </div>
    ),
  },
  {
    ...
    icon: MessageSquare,
    description:
      'Use dedicated channels for every project. Every message is indexed and fed into the AI context window so nothing is ever lost.',
    demo: (
      <div className="flex flex-col gap-2.5">
        {[
          ...
          >
            ...
            <span className="font-mono text-sm font-bold" style={{ color: '#1E2636' }}>
              #{c.name}
            </span>
            <span className="ml-auto text-[10px] font-medium" style={{ color: '#4A5578' }}>
              {c.sub}
            </span>
          </div>
        ))}
  ...
  },
  {
    ...
    icon: Sparkles,
    description:
      'AI extracts tasks, generates the morning digest, answers questions, and keeps the knowledge base current — automatically, every day.',
    demo: (
      <div className="flex flex-col gap-2.5">
        {[
          ...
          >
            ...
            <span className="text-xs font-medium flex-1" style={{ color: '#1E2636' }}>
              {item.text}
            </span>
            <span
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          style={{
            ...
            top: '10%',
            right: '-10%',
            animation: 'hiw-orb-1 25s ease-in-out infinite',
        ...
        <div
          style={{
            ...
            bottom: '10%',
            left: '-8%',
            animation: 'hiw-orb-2 32s ease-in-out infinite 6s',
            willChange: 'transform',
          }}
        />
      </div>
      ...
      <div className="relative max-w-screen-xl mx-auto px-6 lg:px-10">
          ...
          <div className="pt-28 pb-20 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
            <div>
              ...
              >
                Three steps
                <br />
                <span style={{ color: '#3E4A89' }}>to full</span>
                <br />
                context.
              </h2>
            </div>
            <p
              ...
              style={{ color: '#4A5578' }}
            >
              From zero to fully operational in minutes — your team will be running on EduTechExOS
              before lunch.
            </p>
          </div>
        </AnimatedSection>
              ...
              <AnimatedSection key={step.id} direction="up" delay={i * 0.1}>
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      borderRight: isEven ? 'none' : '1px solid rgba(0,0,0,0.08)',
                      borderLeft: isEven ? '1px solid rgba(0,0,0,0.08)' : 'none',
                    }}
                  >
                    ...
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <span
                        className="font-mono text-xs font-bold tracking-[0.18em] uppercase"
                        style={{ color: '#4A5578' }}
                      >
                        Step {step.number}
                      </span>
                    ...
                    <p
                      ...
                      style={{ color: '#4A5578', maxWidth: '38ch' }}
                    >
                      {step.description}
                    </p>
                  </div>
        ...
        <AnimatedSection direction="up" delay={0.4}>
          <div className="flex items-center justify-center gap-4 py-14 font-mono text-xs">
            ...
            <span className="font-bold tracking-[0.22em] uppercase" style={{ color: '#4A5578' }}>
              From setup to live
            </span>
            <span className="font-black tracking-[0.22em]" style={{ color: '#3E4A89' }}>
              — &lt; 2 MINUTES
            </span>
            <div className="h-px flex-1" style={{ background: 'rgba(0,0,0,0.08)' }} />
          </div>
