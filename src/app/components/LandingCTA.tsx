      ...
      <div className="relative w-full max-w-screen-2xl mx-auto">
        ...
        >
          <AnimatedSection direction="up">
            <div className="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/[0.06] backdrop-blur-xl mb-10" style={{ border: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <p className="text-lg md:text-xl text-dark-muted font-semibold max-w-xl mx-auto mb-12 leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center">
              <Link
                href="/dashboard"
                className="group relative inline-flex items-center justify-center gap-2.5 bg-gradient-to-r from-primary to-green-light text-white font-bold px-12 py-4 text-lg rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:shadow-primary/30 hover:scale-[1.03] active:scale-[0.98]"
              >
