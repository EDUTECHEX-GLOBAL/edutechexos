      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div
          style={{
            ...
            height: 560,
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(62,74,137,0.16) 0%, transparent 65%)',
            filter: 'blur(60px)',
            top: '-20%',
            left: '-10%',
            animation: 'cta-orb-1 22s ease-in-out infinite',
        ...
        <div
          style={{
            ...
            height: 480,
            borderRadius: '50%',
            background: 'radial-gradient(circle, rgba(42,53,104,0.12) 0%, transparent 65%)',
            filter: 'blur(64px)',
            bottom: '-15%',
            right: '-8%',
            animation: 'cta-orb-2 28s ease-in-out infinite 4s',
            willChange: 'transform',
          }}
        />
        <div
          style={{
            ...
            top: '40%',
            right: '30%',
            animation: 'cta-orb-3 18s ease-in-out infinite 8s',
            willChange: 'transform',
          }}
        />
      </div>
