...
export default function LandingFooter() {
  ...
  return (
    <footer className="relative bg-dark">
      ...
      <div className="relative max-w-screen-2xl mx-auto px-6 lg:px-10 py-24">
        <GlassSection padding="p-10 md:p-14 lg:p-16" maxWidth="max-w-6xl">
          ...
          <AnimatedSection direction="up" delay={0.2}>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-14 pt-8" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
