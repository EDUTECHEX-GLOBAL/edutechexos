  ...
  return (
    <>
      <style>{`
        ...
        .rg-cell.rg-pulse:not(.rg-filled) {
          animation: rg-pulse-anim ${pulseDuration}ms forwards;
        }
        @keyframes rg-pulse-anim {
          0%   { background-color: ${cellColor};  transform: scale(1); }
          50%  { background-color: ${pulseColor}; transform: scale(${pulseScale}); }
          100% { background-color: ${cellColor};  transform: scale(1); }
        }
      `}</style>
